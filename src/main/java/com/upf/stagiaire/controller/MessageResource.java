...
public class MessageResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new message, or with status 400 (Bad
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated message, or with status 400 (Bad
     *         Request) if the message is not valid, or with status 500 (Internal Server Error) if the message couldn't
     *         be updated
     * @throws URISyntaxException
     *             if the Location URI syntax is incorrect
     */
